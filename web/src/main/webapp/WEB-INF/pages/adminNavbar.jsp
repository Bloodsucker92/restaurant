        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form class="navbar-form navbar-right" action="${logoutUrl}" method="get">
                ...
                <button class="btn btn-danger" type="submit" style="height: 35px;">
                    <p style="color: white"><spring:message code="user.logout"/></p>
                </button>
            </form>
            <form class="navbar-form navbar-right">
                <h6 align="center"><spring:message code="main.youhaveloggedin"></spring:message> ${sessionScope.loggedinuser}</h6>
            </form>
